...
> Brink, C. (2026). *Phantom mass: an intrinsic per-element measure of abstract-domain conflation, with registered experiments on exactly when it predicts analysis error.* Draft v0.3, September 2026. (Zenodo DOI to be assigned on deposit.)
