...
**Files.**
- [`FalseWorkPapers/Positions.lean`](FalseWorkPapers/Positions.lean) — index file; theorem-candidate statement; ranked open questions; framework-writeup-pending notes; two-parameter-unification closure summary.
