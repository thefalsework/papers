...
- **Paper:** Paper 1 § 3.4 (v11.8 architectural-revision note); Paper 3 § 4 (v9.4 architectural-status note); canonical prose statement at [`../papers/comma-formal-structure-note.md`](../papers/comma-formal-structure-note.md); Lean sketch at [`../lean/FalseWorkPapers/Positions/`](../lean/FalseWorkPapers/Positions/)
...
- **Status:** awaiting category theorist or topos theorist; v0.6 records the 2026-05-17 Mathlib `HeytingAlgebra (Subobject _)` upstream-gap triage with Edward van de Meent (Zulip), v0.5 records the 2026-05-17 Infrastructure predicate repair and explicit Theorem 0 statement, v0.4 records the 2026-05-09 closure-residue commitment, the 2026-05-10 Commitment-as-gate reframe, and the 2026-05-10 two-parameter unification closure. Upstream-dependency posture documented at [`../lean/HEYTING-GAP.md`](../lean/HEYTING-GAP.md)
- **Related:** [`music-kernel-umbrella`](claims/music-kernel-umbrella.md) (the position dictionary's music instantiation runs on the music-kernel endofunctor)
