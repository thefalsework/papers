...
(* ================================================================
   FalseWork Algebra Prototype - SINGLE-FILE BUNDLE  (v1.3)
   ----------------------------------------------------------------
   v1.3 - Schema correction (Paper 1 sec. 4.3-grounded):
            ...
            - CommaMethodologySelfReference.IrreducibilityKind
              changed from BoundaryDiscriminationAtLimit to
              RecursiveSelfApplicationGap (its own shape).
            - KEY RESULT block rewritten as coherence
              demonstration rather than empirical proof.
